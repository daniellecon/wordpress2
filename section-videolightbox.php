...
if ( ( ! $disable && ( $video || $heading ) )  || sovenco_is_selective_refresh() ) {
    ...
    ?>
    <section id="<?php if ($id != '') echo esc_attr( $id ); ?>" <?php do_action('sovenco_section_atts', 'videolightbox'); ?>
         class="<?php echo esc_attr(apply_filters('sovenco_section_class', 'section-videolightbox section-padding section-padding-larger section-inverse onepage-section', 'videolightbox')); ?>">
